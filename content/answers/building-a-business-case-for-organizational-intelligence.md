---
title: "Building a business case for organizational intelligence"
slug: building-a-business-case-for-organizational-intelligence
description: "A framework for building a business case for knowledge management tools, with ROI calculations, audience-specific framing, and answers to common objections."
excerpt: "A good business case for knowledge management is built on three things: the cost of the current problem, the expected improvement, and a low-risk way to prove it works. Here is how to assemble each piece."
type: answer
...
ctaLabel: "Start your free Internode trial to gather proof"
relatedSlugs:
...
For more detail on these calculations, see [the hidden cost of scattered knowledge at work](/the-hidden-cost-of-scattered-knowledge-at-work).
